...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", content: "Our Kashmir Honeymoon Special includes 5 nights (2 on houseboat, 3 in hotel), all sightseeing, private cab, complimentary romantic welcome decoration and cake at the houseboat. Starting from ₹18,999 per person." },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "tip_box", content: "Consider Char Dham by Helicopter for seniors and those with health restrictions: complete all four dhams in just 1–2 days with dedicated helicopter packages starting at ₹1,50,000 per person." },
      { type: "callout", content: "Our Char Dham packages (10–12 days) start from ₹28,000/person with private vehicle, experienced guide, all accommodation, and yatra registration support." },
    ],
    relatedPackageSlugs: ["kedarnath-yatra-5-nights-6-days"],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", content: "Solang Valley in December offers skiing, snowboarding, sledding, snowball fights, and snow tubing. The valley typically has 3–5 feet of snow from mid-December. Gear rental is available on the spot. Professional ski instructors are available for beginners — a full-day ski lesson costs ₹1,500–2,500." },
      ...
      { type: "callout", content: "Our Manali Winter Package (4 nights, 5 days) includes Solang Valley snow activities, private cab, heated accommodation, and all meals. Available from ₹13,999 per person." },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", content: "Tandem paragliding from hills above Rishikesh with views of the Ganga valley is available from multiple operators. Flights range from 10–20 minutes and cost ₹1,500–2,500. The best paragliding site near Rishikesh is actually from Bir Billing (3.5 hours away) — if you have an extra day, this is the world's second-highest paragliding site." },
      { type: "callout", content: "Our Rishikesh Adventure Weekend Package includes 16km Ganga rafting, guided yoga session, riverside camp with bonfire, and all transfers from Delhi — starting from ₹6,500 per person." },
    ],
    relatedPackageSlugs: [],
