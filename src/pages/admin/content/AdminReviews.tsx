...
export default function AdminReviews() {
  ...
  const fetchReviews = async () => {
    ...
    if (data) setReviews(data as ModerationReview[]);
    setIsLoading(false);
  };
  ...
  return (
    <div>
      <h1 className="text-2xl font-display font-bold text-gray-900 mb-6">Moderate Reviews</h1>
      {isLoading ? (
                  ...
                  reviews.map((review) => (
                    <tr key={review.id} className="border-b border-border last:border-0">
                      ...
                      <td className="px-6 py-4">
                        ...
                        <p className="text-xs line-clamp-2" title={review.content ?? undefined}>
                          {review.content}
                        </p>
                      </td>
                      <td className="px-6 py-4">
