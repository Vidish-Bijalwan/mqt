            ...
            return (
              <ScrollReveal key={vibe.id} delay={i * 0.12}>
                <motion.button
                  whileHover={{ y: -6 }}
                  whileTap={{ scale: 0.97 }}
                  onClick={() => openPlanner({ trip_style: [vibe.style as any] }, 'discovery_section')}
                ...
                >
                  ...
                  />
                  {/* Gradient overlay */}
                  <div className={`absolute inset-0 bg-gradient-to-t ${vibe.gradient} opacity-75 group-hover:opacity-85 transition-opacity duration-300`} />
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-end text-white">
                    ...
                    <p className="text-sm text-white/80 mb-4 leading-relaxed">{vibe.desc}</p>
