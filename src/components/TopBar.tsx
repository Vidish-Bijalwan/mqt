    ...
    <div className="hidden lg:block bg-primary text-primary-foreground">
      <div className="container mx-auto flex items-center justify-between py-2 text-sm font-body">
        <div className="flex items-center gap-6">
          <a href="tel:+918171158569" className="flex items-center gap-1.5 hover:text-accent transition-colors">
            <Phone className="h-3.5 w-3.5" />
            <span>+91-8171158569</span>
          </a>
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://wa.me/918171158569?text=Hi!%20I'm%20interested%20in%20booking%20a%20tour."
            target="_blank"
