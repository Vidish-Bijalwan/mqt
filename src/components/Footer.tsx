        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-6">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            <div className="space-y-2 text-sm text-dark-foreground/70">
              <a href="tel:+918171158569" className="flex items-center gap-2 hover:text-accent transition-colors">
                <Phone className="h-3.5 w-3.5" /> +91-8171158569
              </a>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="https://wa.me/918171158569" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full bg-dark-foreground/10 flex items-center justify-center hover:bg-success transition-colors">
          ...
          <div className="grid grid-cols-1 min-[400px]:grid-cols-2 md:grid-cols-4 gap-8 min-[400px]:gap-6 col-span-1 md:col-span-3 lg:col-span-4">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-sm text-dark-foreground/60">
                ...
                <li className="hidden sm:block"><Link to="/destinations/uttar-pradesh/varanasi" className="hover:text-accent transition-colors">Varanasi Tour</Link></li>
                <li className="hidden sm:block"><Link to="/destinations/uttarakhand/char-dham" className="hover:text-accent transition-colors">Char Dham Yatra</Link></li>
                <li><Link to="/destinations" className="text-accent flex items-center gap-1 hover:underline">View All <span className="text-[10px]">→</span></Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-sm text-dark-foreground/60">
                ...
                <li className="hidden sm:block"><Link to="/packages/solo" className="hover:text-accent transition-colors">Solo Travel</Link></li>
                <li className="hidden sm:block"><Link to="/packages/luxury" className="hover:text-accent transition-colors">Luxury Packages</Link></li>
                <li className="hidden sm:block"><Link to="/packages/weekend" className="hover:text-accent transition-colors">Weekend Getaways</Link></li>
              </ul>
            </div>
            ...
            <div className="hidden md:block">
              ...
              <ul className="space-y-1.5 text-sm text-dark-foreground/60">
                ...
                <li><Link to="/itineraries" className="hover:text-accent transition-colors">Our Itineraries</Link></li>
